...
namespace E_Barangay.Class
{
    public class RichTextBoxPrintCtrl : RichTextBox
    {
        ...
        /// <param name="charTo">Index of last character to be printed</param>
        /// <returns> (Index of last character that fitted on the page) + 1</returns>
        public int FormatRange(PrintPageEventArgs e, Rectangle r)
        {
            // Specify which characters to print
            STRUCT_CHARRANGE cr = default(STRUCT_CHARRANGE);
            cr.cpMin = 0;
            cr.cpMax = Text.Length;

            // Specify the area inside page margins
            STRUCT_RECT rc = default(STRUCT_RECT);
            rc.top = HundredthInchToTwips(r.Top);
            rc.bottom = HundredthInchToTwips(r.Bottom);
            rc.left = HundredthInchToTwips(r.Left);
            rc.right = HundredthInchToTwips(r.Right);
    ...
    public static class RTBPrintExtension
    {
        public static void AddUnderlinedBoldText(this RichTextBoxPrintCtrl r, string s)
        {
            r.SelectionFont = Printing.fontBoldUnderline;
            r.AppendText(s);
            r.SelectionFont = Printing.font;
        }
    }
}
